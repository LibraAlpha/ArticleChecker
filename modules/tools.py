...
if __name__ == '__main__':
    ...
    store_asset(r, 'www.taobaoxxx.com', 'taobao_title', 'This is a desc', False, False)
    store_asset(r, 'www.taobaoxxx.com', 'taobao_title_b', 'This is a desc blocked', True, False)
    info = read_asset(r, 'www.taobaoxxx.com', is_blocked=True, is_checked=False)
    print(info['title'])
